...
local MenuBackground = "graphics/ui/Menu_background_with_title.png" -- JFO
...
DefineMenuItem("pos", { 128, 11}, "font", "large", "init", "game-menu-init",
  "text", {"caption", "Menu du jeu", "align", "center"},
  "menu", "menu-game")
...
DefineMenuItem("pos", { 16, 288 - 40}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Continuer la Partie (~<Esc~>)",
    "hotkey", "esc",
...
DefineMenuItem("pos", { 144, 11}, "font", "large", "init", "victory-init",
  "text", {"caption", "FÇlicitations !", "align", "center"},
  "menu", "menu-victory")
DefineMenuItem("pos", { 144, 32}, "font", "large",
  "text", {"caption", "Vous avez vaincus !", "align", "center"},
  "menu", "menu-victory")
...
DefineMenuItem("pos", { 144, 11}, "font", "large", "init", "defeated-init",
  "text", {"caption", "Vous avez", "align", "center"},
  "menu", "menu-defeated")
DefineMenuItem("pos", { 144, 32}, "font", "large",
  "text", {"caption", "lamentablement echouÇ!", "align", "center"},
  "menu", "menu-defeated")
DefineMenuItem("pos", { 32, 56}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!OK",
...
DefineMenuItem("pos", { 144, 11}, "font", "large", "init", "save-replay-init", "exit", "save-replay-exit",
  "text", {"caption", "Sauver le Replay", "align", "center"},
...
DefineMenuItem("pos", { 176, 8}, "font", "large", "init", "scen-select-init",
  "text", {"caption", "Choix ScÇnario", "align", "center"},
...
DefineMenuItem("pos", { 132, 80}, "font", "large",
  "text", {"caption", "Taille de carte:", "align", "right"},
  "menu", "menu-select-scenario")
DefineMenuItem("pos", { 140, 80}, "font", "game",
  "pulldown",  {"size", {192, 20},
    "style", "pulldown",
    "func", "scen-select-tpms-action",
    "options", {"Toute taille", "32 x 32", "64 x 64", "96 x 96", "128 x 128", "256 x 256", "512 x 512", "1024 x 1024" },
    "default", 0,
    "current", 0},
  "menu", "menu-select-scenario")
...
DefineMenuItem("pos", { 208, 104 + (36 * 0)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Partie en ~!Solo", -- __JFO
    "hotkey", "s",
    "func", "single-player-game-menu",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 1)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Partie en ~!Multi-joueur",
    "hotkey", "m",
    "func", "multi-player-game-menu",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 2)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Partie en ~!Campagne",
    "hotkey", "c",
    "func", "campaign-game-menu",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 3)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Charger une partie (~!L)",
    "hotkey", "l",
    "func", "load-game-menu",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 4)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Rejouer une partie",
    "hotkey", "r",
    "func", "replay-game-menu",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 5)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Options",
    "hotkey", "o",
    ...
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 6)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Editeur",
    "hotkey", "e",
    ...
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 7)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Voir les crÇdits",
    "hotkey", "v",
    "func", "game-show-credits",
    "style", "gm-full"},
  "menu", "menu-program-start")
DefineMenuItem("pos", { 208, 104 + (36 * 8)}, "font", "large",
  "button", {"size", {224, 27},
...
DefineMenuItem("pos", { 176, 11}, "font", "large", "init", "global-options-init", "exit", "global-options-exit",
  "text", {"caption", "Options Globales", "align", "center"},
  "menu", "menu-global-options")
DefineMenuItem("pos", { 16, 44}, "font", "game",
  "text", {"caption", "RÇsolution VidÇo", "align", "left"},
  "menu", "menu-global-options")
...
DefineMenuItem("pos", { (640 / 2) + 12, 192}, "font", "large",
  "text", {"caption", "~<Configuration de la Partie en Solo~>", "align", "center"}, -- __JFO
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 640 - 224 - 16, 360 + (36 * 0)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Choix Sc~!Çnario",
    "hotkey", "e",
...
DefineMenuItem("pos", { 220, (10 + 240) - 20}, "font", "game",
  "text", {"caption", "~<Ressources:~>"},
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 220, 10 + 240}, "font", "game",
  "pulldown", {"size", {152, 20},
    "style", "pulldown",
    "func", "game-res-action",
    "options", {"Carte par DÇfaut", "Basse", "Moyenne", "ElevÇe" },
    "default", 0,
    "current", 0},
  "menu", "menu-custom-game")
...
DefineMenuItem("pos", { 640 - 224 - 16, 10 + 240}, "font", "game",
  "pulldown", {"size", {190, 20},
    ...
    "options", {"Carte par DÇfaut", "Un Seul Paysan" },
    "default", 0,
    "current", 0},
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 40, (10 + 300) - 20}, "font", "game",
  "text", {"caption", "~<Adversaires:~>"},
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 40, 10 + 300}, "font", "game",
  "pulldown", {"size", {152, 20},
    "style", "pulldown",
    "func", "custom-game-ops-action",
    "options", {"Carte par DÇfaut", "1 Adversaire", "2 Adversaires", "3 Adversaires", "4 Adversaires", "5 Adversaires", "6 Adversaires", "7 Adversaires", "8 Adversaires", "9 Adversaires", "10 Adversaires", "11 Adversaires", "12 Adversaires", "13 Adversaires", "14 Adversaires" },
    "default", 0,
    "current", 0},
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 220, (10 + 300) - 20}, "font", "game",
  "text", {"caption", "~<Terrain de la carte:~>"},
  "menu", "menu-custom-game")
...
DefineMenuItem("pos", { 640 - 224 - 16, (10 + 300) - 20}, "font", "game",
  "text", {"caption", "~<Type de Partie:~>"},
  "menu", "menu-custom-game")
DefineMenuItem("pos", { 640 - 224 - 16, 10 + 300}, "font", "game",
  "pulldown", {"size", {190, 20},
    "style", "pulldown",
    "func", "game-gat-action",
    "options", {"Paramctres de la carte", "MelÇe", "Chacun pour Soi", "Haut vs Bas", "Gauche vs Droite", "Homme vs Machine" },
    "default", 0,
    "current", 0},
  "menu", "menu-custom-game")
...
DefineMenuItem("pos", { 144, 11}, "font", "game",
  "text", {"caption", "Entrer votre nom:", "align", "center"},
...
DefineMenuItem("pos", { (640 / 2) + 12, 8}, "font", "large",
  "text", {"caption", "~<Configuration Multi-joueur~>", "align", "center"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 640 - 224 - 16, 360 + (36 * 0)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Choix Sc~!Çnario",
...
DefineMenuItem("pos", { 640 - 224 - 16, 10 + 240}, "font", "game",
  ...
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, (10 + 300) - 20}, "font", "game",
  "text", {"caption", "~<Brouillard de Guerre:~>"},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 40, 10 + 300}, "font", "game",
  "pulldown",  {"size", {152, 20},
    "style", "pulldown",
    "func", "multi-game-fws-action",
    "options", {"Brouillard de Guerre", "Pas de Brouillard", "RÇvÇller la carte", "Carte rÇvÇlÇ, pas de brouillard" },
    "default", 0,
    "current", 0},
  "menu", "menu-multi-setup")
DefineMenuItem("pos", { 220, (10 + 300) - 20}, "font", "game",
...
DefineMenuItem("pos", { 640 - 224 - 16, 10 + 300}, "font", "game",
  "pulldown",  {"size", {190, 20},
    "style", "pulldown",
    "func", "game-gat-action",
    "options", {"Paramctres de la carte", "MÇlÇe", "Chacun pour soi", "Haut vs Bas", "Gauche vs Droite", "Homme vs Machine" },
    "default", 0,
    "current", 0},
  "menu", "menu-multi-setup")
...
DefineMenuItem("pos", { 128, 11}, "font", "large", "init", "objectives-init",
  "text", {"caption", "Objectifs", "align", "center"},
...
DefineMenuItem("pos", { 128, 11}, "font", "large",
  "text", {"caption", "Fin du ScÇnario", "align", "center"},
  "menu", "menu-end-scenario")
DefineMenuItem("pos", { 16, 40 + (36 * 0)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!RedÇmarrer Scenario",
    "hotkey", "r",
...
DefineMenuItem("pos", { 16, 40 + (36 * 3)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Quitter le Programme (~!X)",
    "hotkey", "x",
...
DefineMenuItem("pos", { 176, 11}, "font", "large", "init", "sound-options-init", "exit", "sound-options-exit",
  "text", {"caption", "Options du son", "align", "center"},
  "menu", "menu-sound-options")
DefineMenuItem("pos", { 16, 36 * 1}, "font", "game",
  "text", {"caption", "Volume Principal", "align", "left"},
  "menu", "menu-sound-options")
...
DefineMenuItem("pos", { 16, 36 * 3}, "font", "game",
  "text", {"caption", "Volume de la musique", "align", "left"},
  "menu", "menu-sound-options")
...
DefineMenuItem("pos", { 16, 36 * 5}, "font", "game",
  "text", {"caption", "Volume du CD", "align", "left"},
  "menu", "menu-sound-options")
...
DefineMenuItem("pos", { 128, 11}, "font", "large", "init", "preferences-init", "exit", "preferences-exit",
  "text", {"caption", "PrÇfÇrences", "align", "center"},
  "menu", "menu-preferences")
DefineMenuItem("pos", { 16, 36 * 1}, "font", "large",
  "gem", {"size", {18, 18},
    "text", "Activer le Brouillard de Guerre",
    "state", "unchecked",
    "func", "set-fog-of-war",
    "style", "gem-square"},
  "menu", "menu-preferences")
DefineMenuItem("pos", { 16, 36 * 2}, "font", "large",
  "gem", {"size", {18, 18},
    "text", "Afficher les raccourcis clavier",
    "state", "unchecked",
...
DefineMenuItem("pos", { 136, 30}, "font", "game", "init", "diplomacy-init", "exit", "diplomacy-exit",
  "text", {"caption", "AlliÇs", "align", "center"},
  "menu", "menu-diplomacy")
DefineMenuItem("pos", { 196, 30}, "font", "game",
  "text", {"caption", "Ennemis", "align", "center"},
  "menu", "menu-diplomacy")
DefineMenuItem("pos", { 286, 30}, "font", "game",
  "text", {"caption", "Vision partagÇe", "align", "center"},
  "menu", "menu-diplomacy")
DefineMenuItem("pos", { 176, 11}, "font", "large",
  "text", {"caption", "Diplomatie", "align", "center"},
  "menu", "menu-diplomacy")

DefineMenuItem("pos", { 16, (18 * 1) + 26}, "font", "game",
  "text", {"caption", "Joueur 1", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 2) + 26}, "font", "game",
  "text", {"caption", "Joueur 3", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 3) + 26}, "font", "game",
  "text", {"caption", "Joueur 4", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 4) + 26}, "font", "game",
  "text", {"caption", "Joueur 5", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 5) + 26}, "font", "game",
  "text", {"caption", "Joueur 6", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 6) + 26}, "font", "game",
  "text", {"caption", "Joueur 7", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 7) + 26}, "font", "game",
  "text", {"caption", "Joueur 8", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 8) + 26}, "font", "game",
  "text", {"caption", "Joueur 9", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 9) + 26}, "font", "game",
  "text", {"caption", "Joueur 10", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 10) + 26}, "font", "game",
  "text", {"caption", "Joueur 11", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 11) + 26}, "font", "game",
  "text", {"caption", "Joueur 12", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 12) + 26}, "font", "game",
  "text", {"caption", "Joueur 13", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 13) + 26}, "font", "game",
  "text", {"caption", "Joueur 14", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 16, (18 * 14) + 26}, "font", "game",
  "text", {"caption", "Joueur 15", "align", "left"},
  "menu", "menu-diplomacy")
...
DefineMenuItem("pos", { 128, 11}, "font", "large", "init", "speed-options-init", "exit", "speed-options-exit",
  "text", {"caption", "Paramctres de Vitesse", "align", "center"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 16, 36 * 1}, "font", "game",
  "text", {"caption", "Vitesse de la Partie", "align", "left"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 32, 36 * 1.5}, "font", "small",
  "hslider", {"size", {198, 18},
...
DefineMenuItem("pos", { 34, (36 * 2) + 6}, "font", "small",
  "text", {"caption", "lente", "align", "left"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 230, (36 * 2) + 6}, "font", "small",
  "text", {"caption", "rapide", "align", "right"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 16, 36 * 3}, "font", "game",
  "text", {"caption", "DÇplacement a la 	Souris", "align", "left"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 32, 36 * 3.5}, "font", "small",
  "hslider", {"size", {198, 18},
...
DefineMenuItem("pos", { 230, (36 * 4) + 6}, "font", "small",
  ...
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 16, 36 * 5}, "font", "game",
  "text", {"caption", "DÇplacement au Clavier", "align", "left"},
  "menu", "menu-speed-options")
DefineMenuItem("pos", { 32, 36 * 5.5}, "font", "small",
  "hslider", {"size", {198, 18},
...
DefineMenu("name", "menu-game-options", "geometry", {272, 96, 256, 288},
  "panel", "panel1", "default", 5)
DefineMenuItem("pos", { 128, 11}, "font", "large",
  "text", {"caption", "Options de Partie", "align", "center"},
...
DefineMenuItem("pos", { 144, 11}, "font", "large", "init", "tips-init", "exit", "tips-exit",
  "text", {"caption", "Trucs et Astuces de Stratagus", "align", "center"},
  "menu", "menu-tips")
DefineMenuItem("pos", { 14, 256 - 75}, "font", "game",
  "gem", {"size", {18, 18},
    "text", "Montrer au DÇmarrage",
    "state", "checked",
...
DefineMenuItem("pos", { 128, 11}, "font", "large",
  "text", {"caption", "Aide", "align", "center"},
  "menu", "menu-help")
DefineMenuItem("pos", { 16, 40 + (36 * 0)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "Raccourcis Clavier (~!H)",
    "hotkey", "h",
...
DefineMenuItem("pos", { 16, 40 + (36 * 1)}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Trucs & Astuces Strategus",
    "hotkey", "t",
    "func", "tips-menu",
    "style", "gm-full"},
  "menu", "menu-help")
...
DefineMenuItem("pos", { 352 / 2, 11}, "font", "large",
  "text", {"caption", "Aide des Raccourcis Clavier", "align", "center"},
...
DefineMenuItem("pos", { 384 / 2, 11}, "font", "large",  "init", "save-game-init", "exit", "save-game-exit",
  "text", {"caption", "Sauvegarder la Partie", "align", "center"},
  "menu", "menu-save-game")
...
-- menu-load-game
--
DefineMenu("name", "menu-load-game", "geometry", {128, 112, 384, 256},
...
DefineMenuItem("pos", { 384 / 2, 11}, "font", "large",  "init", "load-game-init", "exit", "load-game-exit",
  "text", {"caption", "Charger une Partie", "align", "center"},
  "menu", "menu-load-game")
...
DefineMenuItem("pos", { 288 / 2, 11}, "font", "large",  "init", "save-confirm-init", "exit", "save-confirm-exit",
  "text", {"caption", "êcraser le fichier", "align", "center"},
  "menu", "menu-save-confirm")
DefineMenuItem("pos", { 16, 11 + (20 * 1.5)}, "font", "game",
  "text", {"caption", "Etes vous sur de vouloir Çcraser", "align", "left"},
  "menu", "menu-save-confirm")
...
DefineMenuItem("pos", { 288 / 2, 11}, "font", "large",  "init", "delete-confirm-init", "exit", "delete-confirm-exit",
  "text", {"caption", "Supprimer Fichier", "align", "center"},
  "menu", "menu-delete-confirm")
DefineMenuItem("pos", { 16, 11 + (20 * 1.5)}, "font", "game",
  "text", {"caption", "Etes vous sur de vouloir supprimer", "align", "left"},
  "menu", "menu-delete-confirm")
DefineMenuItem("pos", { 16, 11 + (20 * 2.5)}, "font", "game",
  "text", {"caption", nil, "align", "left"},
  "menu", "menu-delete-confirm")
...
DefineMenuItem("pos", { 14 + 22, (256 - 75) + 4}, "font", "game",
  "text", {"caption", "Montrer au DÇmarrage", "align", "left"},
  "menu", "menu-editor-tips")
DefineMenuItem("pos", { 14, 256 - 40}, "font", "large",
  "button", {"size", {106, 27},
    "caption", "~!Next Tip",
...
DefineMenu("name", "menu-surrender-confirm", "geometry", {272, 96, 256, 288},
  "panel", "panel1", "default", 4)
DefineMenuItem("pos", { 128, 11}, "font", "large",
  "text", {"caption", "Etes vous certain", "align", "center"},
  "menu", "menu-surrender-confirm")
DefineMenuItem("pos", { 128, 11 + (24 * 1)}, "font", "large",
  "text", {"caption", "de vouloir dÇclarer", "align", "center"},
  "menu", "menu-surrender-confirm")
DefineMenuItem("pos", { 128, 11 + (24 * 2)}, "font", "large",
  "text", {"caption", "forfait ?", "align", "center"},
  "menu", "menu-surrender-confirm")
DefineMenuItem("pos", { 16, 11 + (24 * 3) + 29}, "font", "large",
  "button", {"size", {224, 27},
    "caption", "~!Forfait",
...
DefineMenuItem("pos", { 128, 11 + (24 * 1)}, "font", "large",
  "text", {"caption", "de vouloir revenir", "align", "center"},
  "menu", "menu-quit-to-menu-confirm")
DefineMenuItem("pos", { 128, 11 + (24 * 2)}, "font", "large",
  "text", {"caption", "au menu principal ?", "align", "center"},
  "menu", "menu-quit-to-menu-confirm")
DefineMenuItem("pos", { 16, 11 + (24 * 3) + 29}, "font", "large",
  "button", {"size", {224, 27},
...
DefineMenuItem("pos", { 128, 11 + (24 * 1)}, "font", "large",
  "text", {"caption", "de vouloir quitter", "align", "center"},
  "menu", "menu-exit-confirm")
DefineMenuItem("pos", { 128, 11 + (24 * 2)}, "font", "large",
